...
The packaged datasets and baseline artifacts are local, but the
\texttt{Charts} tab loads \texttt{Chart.js} from a standard CDN, so the
intended TA path assumes a normal internet connection, with the terminal menu
remaining the documented backup method.
