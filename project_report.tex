...
the evolving bid and ask queues, which matches our focus on how local book
...
changing the main computational challenge, which was to represent and update a live
order book efficiently with trees while connecting the simulator to
meaningful data and model-training. In the language of our original
...
project's canonical event format so the TA can run fast, reproducible
